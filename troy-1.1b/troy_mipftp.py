...
#import lib_mipftp #No se importa, ya está incorporada

class new_cliente(cliente):
  """Clase similar al cliente de la librería lib_mipftp"""
  pass

#Declara el servidor
h_server=servidor(configuracion,new_cliente)